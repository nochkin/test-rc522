...
uint8_t *Reader2::get_tag()
{
	return tag_full_sn;
}

std::string Reader2::get_tag_str(std::string delim)
{
...
void Reader2::calculate_crc(uint8_t *data, uint8_t data_len, uint8_t *buf)
{
	uint8_t ii, n;
